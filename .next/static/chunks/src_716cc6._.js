(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_716cc6._.js", {
...
function SaveButton({ onClick }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            className: `text-white transition-all duration-300 hover:scale-110 active:scale-90 p-4 ${clicked ? "bg-green-500  rounded-full" : " bg-red-600 rounded-full"}`,
            "aria-label": "Share",
            onClick: ()=>{
                setClicked(true);
                onClick;
...
_s(SaveButton, "NL05b5J4z4O/U6wEzhVGl+YEdv8=");
_c = SaveButton;
var _c;
...
;
;
function EditableText({ initialText, mitigation = false, onSave, className = "" }) {
    _s();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "relative",
        children: [
            hasChanged && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(EditableText, "SHmTBfoL3jgDdvbGKNW/p2Ya3UQ=");
_c = EditableText;
var _c;
...
function StockDataDisplay({ data, id, userId }) {
    ...
    const fetchCompanyOverview = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StockDataDisplay.useCallback[fetchCompanyOverview]": async ()=>{
            if (cachedData && client) {
                try {
                    let { data: companyData, error } = await client.from("company").select("description").eq("name", id);
                    if (!companyData) {
                        const { data: defaultData, error } = await client.from("company").select("description").eq("name", id);
                        companyData = defaultData;
                    }
                    if (error) throw error;
                    if (companyData && companyData.description) {
                        setCompanyDescription(companyData.description);
                        setImageSrc(cachedData.url1 || "https://images.unsplash.com/photo-1456930266018-fda42f7404a7?q=80&w=1595&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D");
                    } else {
    ...
    const fetchKeyMetrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StockDataDisplay.useCallback[fetchKeyMetrics]": async ()=>{
            if (cachedData && client) {
                try {
                    let { data: metricsData, error } = await client.from("company").select("marketCap,sharesOutstanding,float,evEbitda,peTtm,dividendRate").eq("name", data.name);
                    if (!metricsData) {
    ...
    const fetchFinancialHealth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StockDataDisplay.useCallback[fetchFinancialHealth]": async ()=>{
            if (cachedData && client) {
                try {
                    let { data: financialData, error } = await client.from("company").select("cashPosition,totalDebt,debtToEquity,currentRatio").eq("name", data.name);
                    if (!financialData) {
    ...
    const fetchAnalystHealth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StockDataDisplay.useCallback[fetchAnalystHealth]": async ()=>{
            if (cachedData && client) {
                try {
                    let { data: analystData, error } = await client.from("company").select("analystRating,numberOfAnalysts,meanTargetPrice,impliedChange").eq("name", data.name);
                    if (!analystData) {
    ...
    async function savePoints(section, content) {
        ...
        try {
            ...
            if (client) {
                const { data: serverData, error } = await client.from("company").upsert({
                    ticker: id,
                    ...updatedData
                }).select();
                if (error) {
    ...
    function updateNestedStructure(data, index, type, content) {
...
_s(StockDataDisplay, "kepZyQWsLiNpLXQPZbNM554aCGo=");
_c = StockDataDisplay;
function CompanyOverview({ name, description, imageSrc, saveEditedContent, setEditedVals, editedVals }) {
...
_c1 = CompanyOverview;
function KeyMetrics({ metrics, saveEditedContent, setEditedVals, editedVals }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
...
_c2 = KeyMetrics;
function FinancialHealth({ financials, saveEditedContent, setEditedVals, editedVals }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
...
_c3 = FinancialHealth;
function StrengthsAndCatalysts({ strengths, savePoints }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
...
function AnalystHealth({ analystData, saveEditedContent, setEditedVals, editedVals }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        className: "flex w-[80vw] h-[75vh] bg-zinc-900 shadow-2xl shadow-cyan-400 text-gray-100 border-0",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
            className: "flex-1 p-16 items-center justify-center",
...
_c5 = AnalystHealth;
function RisksAnalysis({ points, savePoints }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
...
_c6 = RisksAnalysis;
function Conclusion({ description, imageSrc, saveEditedContent, rec, setEditedVals, editedVals }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        className: "flex w-[80vw] h-[75vh] bg-zinc-900 shadow-2xl shadow-cyan-400 text-gray-100 border-0",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
            ...
            const loadStockData = {
                "Page.useEffect.loadStockData": async ()=>{
                    try {
                        ...
                        const { data: url1, error: err1 } = await supabase.from("company").select("url1").single();
                        const { data: url2, error: err2 } = await supabase.from("company").select("url2").single();
...
//# sourceMappingURL=src_716cc6._.js.map